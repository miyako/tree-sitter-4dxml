...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.count = 1, .reusable = false}, SHIFT(52),
  ...
  [41] = {.count = 2, .reusable = false}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(65),
  [44] = {.count = 2, .reusable = false}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(66),
  [47] = {.count = 2, .reusable = false}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(60),
  [50] = {.count = 2, .reusable = false}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(61),
  [53] = {.count = 2, .reusable = true}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(6),
  [56] = {.count = 1, .reusable = true}, REDUCE(aux_sym_fragment_repeat1, 2),
  [58] = {.count = 2, .reusable = false}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(49),
  [61] = {.count = 2, .reusable = false}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(55),
  [64] = {.count = 2, .reusable = false}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(52),
  [67] = {.count = 2, .reusable = false}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(46),
  [70] = {.count = 2, .reusable = true}, REDUCE(aux_sym_fragment_repeat1, 2), SHIFT_REPEAT(7),
  [73] = {.count = 1, .reusable = true}, REDUCE(sym_fragment, 1),
  [75] = {.count = 1, .reusable = true}, SHIFT(7),
  [77] = {.count = 1, .reusable = true}, SHIFT(36),
  [79] = {.count = 1, .reusable = false}, SHIFT(41),
  [81] = {.count = 1, .reusable = false}, SHIFT(42),
  [83] = {.count = 1, .reusable = true}, SHIFT(37),
  [85] = {.count = 1, .reusable = true}, REDUCE(sym_end_tag, 3),
  [87] = {.count = 1, .reusable = false}, REDUCE(sym_end_tag, 3),
  [89] = {.count = 1, .reusable = true}, REDUCE(sym_doctype, 4),
  [91] = {.count = 1, .reusable = false}, REDUCE(sym_doctype, 4),
  [93] = {.count = 1, .reusable = false}, REDUCE(sym_self_closing_tag, 3),
  [95] = {.count = 1, .reusable = true}, REDUCE(sym_self_closing_tag, 3),
  [97] = {.count = 1, .reusable = false}, REDUCE(sym_element, 2),
  [99] = {.count = 1, .reusable = true}, REDUCE(sym_element, 2),
  [101] = {.count = 1, .reusable = false}, REDUCE(sym_element, 1),
  [103] = {.count = 1, .reusable = true}, REDUCE(sym_element, 1),
  [105] = {.count = 1, .reusable = false}, REDUCE(sym_element, 3),
  [107] = {.count = 1, .reusable = true}, REDUCE(sym_element, 3),
  [109] = {.count = 1, .reusable = false}, REDUCE(sym_self_closing_tag, 4),
  [111] = {.count = 1, .reusable = true}, REDUCE(sym_self_closing_tag, 4),
  [113] = {.count = 1, .reusable = false}, REDUCE(sym_start_tag, 3),
  [115] = {.count = 1, .reusable = true}, REDUCE(sym_start_tag, 3),
  [117] = {.count = 1, .reusable = false}, REDUCE(sym_start_tag, 4),
  [119] = {.count = 1, .reusable = true}, REDUCE(sym_start_tag, 4),
  [121] = {.count = 1, .reusable = true}, REDUCE(sym_erroneous_end_tag, 3),
  [123] = {.count = 1, .reusable = false}, REDUCE(sym_erroneous_end_tag, 3),
  [125] = {.count = 1, .reusable = false}, REDUCE(sym_declaration, 4),
  [127] = {.count = 1, .reusable = true}, REDUCE(sym_declaration, 4),
  [129] = {.count = 1, .reusable = true}, SHIFT(23),
  [131] = {.count = 1, .reusable = true}, SHIFT(22),
  [133] = {.count = 1, .reusable = true}, SHIFT(35),
  [135] = {.count = 1, .reusable = true}, REDUCE(aux_sym_start_tag_repeat1, 2),
  [137] = {.count = 2, .reusable = true}, REDUCE(aux_sym_start_tag_repeat1, 2), SHIFT_REPEAT(35),
  [140] = {.count = 1, .reusable = true}, SHIFT(20),
  [142] = {.count = 1, .reusable = true}, SHIFT(12),
  [144] = {.count = 1, .reusable = true}, SHIFT(21),
  [146] = {.count = 1, .reusable = true}, SHIFT(19),
  [148] = {.count = 1, .reusable = true}, REDUCE(sym_attribute, 1),
  [150] = {.count = 1, .reusable = true}, SHIFT(9),
  [152] = {.count = 1, .reusable = true}, REDUCE(sym_attribute, 3),
  [154] = {.count = 1, .reusable = true}, REDUCE(sym_quoted_attribute_value_empty, 1),
  [156] = {.count = 1, .reusable = true}, REDUCE(sym_quoted_attribute_value, 2),
  [158] = {.count = 1, .reusable = true}, REDUCE(sym_quoted_attribute_value, 3),
  [160] = {.count = 1, .reusable = true}, SHIFT(50),
  [162] = {.count = 1, .reusable = true}, SHIFT(54),
  [164] = {.count = 1, .reusable = false}, SHIFT(38),
  [166] = {.count = 1, .reusable = true}, SHIFT(44),
  [168] = {.count = 1, .reusable = true}, SHIFT(45),
  [170] = {.count = 1, .reusable = true}, SHIFT(59),
  [172] = {.count = 1, .reusable = true}, SHIFT(39),
  [174] = {.count = 1, .reusable = true}, SHIFT(58),
  [176] = {.count = 1, .reusable = true}, SHIFT(53),
  [178] = {.count = 1, .reusable = true},  ACCEPT_INPUT(),
  [180] = {.count = 1, .reusable = true}, SHIFT(47),
  [182] = {.count = 1, .reusable = true}, SHIFT(10),
  [184] = {.count = 1, .reusable = true}, SHIFT(28),
  [186] = {.count = 1, .reusable = true}, SHIFT(33),
  [188] = {.count = 1, .reusable = true}, SHIFT(11),
  [190] = {.count = 1, .reusable = true}, SHIFT(27),
  [192] = {.count = 1, .reusable = true}, SHIFT(64),
  [194] = {.count = 1, .reusable = true}, SHIFT(29),
  [196] = {.count = 1, .reusable = true}, SHIFT(25),
  [198] = {.count = 1, .reusable = true}, SHIFT(24),
  [200] = {.count = 1, .reusable = true}, SHIFT(18),
  [202] = {.count = 1, .reusable = true}, SHIFT(32),
  [204] = {.count = 1, .reusable = true}, SHIFT(56),
  [206] = {.count = 1, .reusable = true}, SHIFT(57),
  [208] = {.count = 1, .reusable = true}, SHIFT(51),
  [210] = {.count = 1, .reusable = true}, SHIFT(62),
